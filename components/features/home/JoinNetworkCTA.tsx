...
export function JoinNetworkCTA() {
  return (
    <div className="container flex flex-col items-center text-center">
      ...
      <p className="w-[704px] text-center justify-center text-orange-100 text-sm font-semibold font-sans capitalize leading-4 pt-4">
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-3">
        ...
        >
          <span className="whitespace-nowrap text-white group-hover:text-yellow-950 text-base font-semibold font-sans leading-5 transition-colors">
            Become a Contributor
          </span>
        </Link>
